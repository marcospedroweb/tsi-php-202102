...
// $vetor = ['indice' => 'valor'];
$gravado = $stmt->execute($valores);

if($gravado){
    header('Location: listar.php?gravado=' . $gravado);//redireciona para a pagina indicada
}else{
    echo "<br><br>Ocorreu um erro na tentativa de gravar os dados<br><br>";
    echo "<a href='./disciplina.html'>Tentar novamente</a>";
}
// var_dump($bd);